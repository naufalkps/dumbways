                            ...
                            <div class="productCard">
                                ...
                                <div class="card-body " style="text-align: center">
                                    <label class="card-text text-center font-weight-bold"
                                        ...
                                        <p style="font-size:20px ">{{ Str::words($product->name,4) }}</p> 
                                        {{ Str::words($product->merk,4) }}
                                        (Qty:{{$product->qty}})</label>
                                    <p class="card-text text-center">Rp. {{ number_format($product->price) }}
                                    </p>
                                </div>
                            </div>
                        </div>
